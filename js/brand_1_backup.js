...
(function($) {
    doc.ready(function() {
		...
		new YMotion([
			...
			[
				{el: '.el2_1', set: {opacity: 1, y: 0}, to: {opacity: 0, y: 25, repeatDelay: 3, repeat: -1}, d: 0.8},
				{el: '.el2_2', set: {opacity: 1, y: 0}, to: {opacity: 0, y: 30, repeatDelay: 3, repeat: -1}, d: 0.8, t:'-=0.4'},
				{el: '.el2_3', set: {opacity: 1, y: 0}, to: {opacity: 0, y: 50, repeatDelay: 3, repeat: -1}, d: 0.8, t:'-=0.4'},
			],
			[
