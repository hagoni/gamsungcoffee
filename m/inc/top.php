...
<div id="wrap">
	...
	?>
    <!-- sub_visual start -->
	<div class="sub_visual sub_visual<?=$gnb_index?> bg w100 t_center">
		<div class="scroll_temp"></div>
        <p class="sub_visual_title"><img src="<?=$root?>/img/sub/page<?=$gnb_index?>_title<?=$minor_index?>.png" alt="<?=$board_list['view3_title_01']?>" class="w100"></p>
        <p class="sub_visual_text"><?=nl2br($board_list['view3_special_02']);?></p>
    </div>
	<!-- //sub_visual end -->
    <!-- lnb_inner start -->
    <div class="lnb_wrap over_h swiper-container">
