		...
		<form class="inquiry_form" method="post" action="<?=BOARD?>/index.php?<?=$path_action?>" enctype="multipart/form-data" accept-charset="<?=SET?>">
			...
			<fieldset class="iqr_policy_wrap">
		        ...
		        <div class="iqr_check">
		            ...
		            <label for="inquiryPolicyCheck" class="rel">개인정보취급방침을 읽었으며 이에 동의합니다.</label>
...
?>
						...
						<li>
							<p class="field_title required<?if($email_required){echo ' required';}?>"><label for="iqr_email_01">이메일</label></p>
							<?=$view_email?>
						</li>
<?
...
?>
						<li>
							<p class="field_title required"><label for="iqr_special_03">창업희망지역</label></p>
							<input type="text" name="special_03" id="iqr_special_03" required="required">
						</li>
						<li>
							<p class="field_title required"><label for="iqr_special_04">예상창업비용</label></p>
							<div class="input_comment">
								<input type="text" name="special_04" id="iqr_special_04">
								<label for="iqr_special_04" class="text">만원 (숫자만 입력해주세요)</label>
							</div>
						</li>
						<li class="over_h">
							<p class="field_title required">점포보유</p>
...
?>
						<li>
							<p class="field_title"><label for="iqr_command_01">문의내용</label></p>
