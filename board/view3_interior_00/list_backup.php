        ...
        <div class="right_area f_right t_center">
            <ul>
                <li>
                    ...
                    <p class="li_txt">
                        ‘넌 커피가 땡긴다’ 같이 트렌디한 한글 네온 사인은<br>
                        감성커피로부터 시작되었습니다.
                    </p>
                </li>
                <li>
...
<!-- //layer1 end -->
<!-- layer2 start -->
<div class="layer2" data-motion-offset="2">
    <div class="text_box">
        <ul class="fs_def">
...
new YMotion([
    ...
    [
        {el: '.el2_1', set: {opacity: 0}, to: {opacity:1}, d: 0.3},
        {el: '.el2_2', set: {opacity: 0}, to: {opacity:1}, d: 0.3, t:'-=0.1'},
        {el: '.el2_3', set: {opacity: 0}, to: {opacity:1}, d: 0.3, t:'-=0.1'},
        {el: '.el2_4', set: {opacity: 0}, to: {opacity:1}, d: 0.3, t:'-=0.1'},
        {el: '.el2_5', set: {opacity: 0}, to: {opacity:1}, d: 0.3, t:'-=0.1'},
        {el: '.el2_6', set: {opacity: 0}, to: {opacity:1}, d: 0.3, t:'-=0.1'},
        {el: '.el2_7', set: {opacity: 0}, to: {opacity:1}, d: 0.3, t:'-=0.1'},
        {el: '.el2_8', set: {opacity: 0}, to: {opacity:1}, d: 0.3, t:'-=0.1'},
        {el: '.el2_9', set: {opacity: 0}, to: {opacity:1}, d: 0.3, t:'-=0.1'},
        {el: '.el2_10', set: {opacity: 0}, to: {opacity:1}, d: 0.3, t:'-=0.1'},
        {el: '.el2_11', set: {opacity: 0}, to: {opacity:1}, d: 0.3, t:'-=0.1'},
        {el: '.el2_12', set: {opacity: 0}, to: {opacity:1}, d: 0.3, t:'-=0.1'},
        {el: '.el2_13', set: {opacity: 0}, to: {opacity:1}, d: 0.3, t:'-=0.1'},
        {el: '.el2_14', set: {opacity: 0}, to: {opacity:1}, d: 0.3, t:'-=0.1'},
        {el: '.el2_15', set: {opacity: 0}, to: {opacity:1}, d: 0.3, t:'-=0.1'},
        {el: '.el2_16', set: {opacity: 0}, to: {opacity:1}, d: 0.3, t:'-=0.1'},
    ],
]).activate();
</script>