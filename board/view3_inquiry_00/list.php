...
if ($view3_sca != 'customer_01') {
	$path = "{$root}/sms/sms_trans.php";
} else {
	$path = BOARD."/index.php?{$path_action}";
}
?>
...
<div id="boardWrap">
	<div class="inquiry_wrap">
		<form name="inquiry_write" method="post" action="<?=$path?>" enctype="multipart/form-data" accept-charset="<?=SET?>" class="inquiry_form">
...
?>
						...
						<tr>
							<th scope="row"><label for="iqr_special_03"  class="required">창업희망지역</label></th>
							<td>
