...
<?
    ...
    while($list = mysql_fetch_assoc($out_sql)) {
        ...
        $next_command_01 = cut($list['view3_command_01'], 70);
        ...
        <li>
            <a href="<?=$path_view?>">
                ...
                <div class="board_list_text">
                    <p class="board_list_right board_list_date"><?=$write_day?></p>
                    <p class="board_list_title ellipsis"><?=$option['notice'].$list['view3_title_01']?></p>
                    <p class="board_list_desc"><?=$next_command_01?></p>
                    <p class="board_btn">자세히 보기</p>
                </div>
            </a>
        </li>
<?
