...
<?
	switch(strtolower($top_list['view3_video'])) {
		case 'youtube':
			...
			break;
		default:
			echo '<iframe src="//player.vimeo.com/video/'.$top_list['view3_link'].'?quality=1080p&autopause=0&playsinline=1&autoplay=1&loop=0&background=0&muted=1" allow="autoplay" width="100%" height="800" frameborder="0" playsinline webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>';
			break;
	}
?>
			</div>
