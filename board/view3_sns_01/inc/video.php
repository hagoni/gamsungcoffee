...
<?
	switch(strtolower($top_list['view3_video'])) {
		case 'youtube':
			echo '<iframe src="//youtube.com/embed/'.$top_list['view3_link'].'?vq=hd1080&rel=0&autoplay=1&loop=0&mute=0" allow="autoplay" width="100%" height="650px" frameborder="0" playsinline webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>';
			break;
		default:
			echo '<iframe src="//player.vimeo.com/video/'.$top_list['view3_link'].'?quality=1080p&autopause=0&playsinline=1&autoplay=1&loop=0&background=0" allow="autoplay" width="100%" height="650px" frameborder="0" playsinline webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>';
			break;
	}
?>
			</div>
