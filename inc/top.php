...
?>
<?if($gnb_index == 1 && $minor_index == 1) {?>
	<!-- 서브배너 start -->
	<div class="sub_visual sub1_visual1 bg rel t_center">
		<div class="sub_title_area">
			<h2 class="sub_title"><img src="<?=$root?>/img/sub/sub<?=$gnb_index?>_title<?=$minor_index?>.png" alt="<?=$board_list['view3_title_01']?>"></h2>
			<p class="sub_text"><?=nl2br($board_list['view3_special_02']);?></p>
		</div>
		<div class="mv_scroll l50">
			<div class="scroll t_center">
				<div class="scr_off"></div>
				<div class="scr_on"></div>
			</div>
			<div class="scroll_text">
				<img src="<?=$root?>/img/main/scr_ttl.png" alt="">
			</div>
		</div>
		<div class="dimension-fix">
			<span class="ovl"></span>
			<div class="video_wrap">
				<iframe src="//player.vimeo.com/video/369762086?quality=1080p&autopause=0&playsinline=1&autoplay=1&loop=1&muted=1&background=1" allow="autoplay" width="100%" height="100%" frameborder="0" playsinline webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
			</div>
		</div>
	</div>
	<!-- //서브배너 end -->
<?} else {?>
    <!-- 서브배너 start -->
    <div class="sub_visual sub_visual<?=$gnb_index?> sub<?=$gnb_index?>_visual<?=$minor_index?> bg rel t_center" data-sub-offset="1">
